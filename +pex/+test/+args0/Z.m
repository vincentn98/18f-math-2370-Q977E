function Y = Z(X, M, small, large)
    ...
    % ------------------------------------------------------------------------
    y = cell(1, M);
    for i = 1 : M, y{i} = {randi([-small, small])}; end
    Y = horzcat(Y, y);
     
    y = cell(1, M);
    for i = 1 : M, y{i} = {randi([-large, large])}; end
    Y = horzcat(Y, y);
    ...
    % ------------------------------------------------------------------------
    y = cell(1, M);
    for i = 1 : M, y{i} = {randi([-small, small]) + rand()}; end
    Y = horzcat(Y, y);

    y = cell(1, M);
    for i = 1 : M, y{i} = {randi([-large, large]) + rand()}; end
    Y = horzcat(Y, y);
