...
function test__mod_mult_inv__count(t)
    pex.test.test_count(t);
end

function test__mod_mult_inv__dependence(t)
    pex.test.test_dependence(t);
end

function test__mod_mult_inv__exception(t)
    pex.test.test_exception(t);
end

function test__mod_mult_inv__format(t)
    pex.test.test_format(t);
end

function test__mod_mult_inv__output(t)
    pex.test.test_output(t);
end

function test__mod_mult_inv__warning(t)
