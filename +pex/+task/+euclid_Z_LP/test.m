...
function test__euclid_Z_LP__count(t)
    pex.test.test_count(t);
end

function test__euclid_Z_LP__dependence(t)
    pex.test.test_dependence(t);
end

function test__euclid_Z_LP__exception(t)
    pex.test.test_exception(t);
end

function test__euclid_Z_LP__format(t)
    pex.test.test_format(t);
end

function test__euclid_Z_LP__output(t)
    pex.test.test_output(t);
end

function test__euclid_Z_LP__warning(t)
