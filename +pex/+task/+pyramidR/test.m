...
function test__pyramidR__count(t)
    pex.test.test_count(t);
end

function test__pyramidR__dependence(t)
    pex.test.test_dependence(t);
end

function test__pyramidR__exception(t)
    pex.test.test_exception(t);
end

function test__pyramidR__format(t)
    pex.test.test_format(t);
end

function test__pyramidR__output(t)
    pex.test.test_output(t);
end

function test__pyramidR__warning(t)
