...
function test__isZ__count(t)
    pex.test.test_count(t);
end

function test__isZ__dependence(t)
    pex.test.test_dependence(t);
end

function test__isZ__exception(t)
    pex.test.test_exception(t);
end

function test__isZ__format(t)
    pex.test.test_format(t);
end

function test__isZ__output(t)
    pex.test.test_output(t);
end

function test__isZ__warning(t)
