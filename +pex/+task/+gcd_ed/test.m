...
function test__gcd_ed__count(t)
    pex.test.test_count(t);
end

function test__gcd_ed__dependence(t)
    pex.test.test_dependence(t);
end

function test__gcd_ed__exception(t)
    pex.test.test_exception(t);
end

function test__gcd_ed__format(t)
    pex.test.test_format(t);
end

function test__gcd_ed__output(t)
    pex.test.test_output(t);
end

function test__gcd_ed__warning(t)
