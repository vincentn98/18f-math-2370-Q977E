...
function test__mult_N_R_2_tail__count(t)
    pex.test.test_count(t);
end

function test__mult_N_R_2_tail__dependence(t)
    pex.test.test_dependence(t);
end

function test__mult_N_R_2_tail__exception(t)
    pex.test.test_exception(t);
end

function test__mult_N_R_2_tail__format(t)
    pex.test.test_format(t);
end

function test__mult_N_R_2_tail__output(t)
    pex.test.test_output(t);
end

function test__mult_N_R_2_tail__warning(t)
