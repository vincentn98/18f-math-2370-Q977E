...
function test__iseven__count(t)
    pex.test.test_count(t);
end

function test__iseven__dependence(t)
    pex.test.test_dependence(t);
end

function test__iseven__exception(t)
    pex.test.test_exception(t);
end

function test__iseven__format(t)
    pex.test.test_format(t);
end

function test__iseven__output(t)
    pex.test.test_output(t);
end

function test__iseven__warning(t)
