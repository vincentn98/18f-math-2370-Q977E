...
function test__pyramidP__count(t)
    pex.test.test_count(t);
end

function test__pyramidP__dependence(t)
    pex.test.test_dependence(t);
end

function test__pyramidP__exception(t)
    pex.test.test_exception(t);
end

function test__pyramidP__format(t)
    pex.test.test_format(t);
end

function test__pyramidP__output(t)
    pex.test.test_output(t);
end

function test__pyramidP__warning(t)
