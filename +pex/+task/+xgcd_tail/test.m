...
function test__xgcd_tail__count(t)
    pex.test.test_count(t);
end

function test__xgcd_tail__dependence(t)
    pex.test.test_dependence(t);
end

function test__xgcd_tail__exception(t)
    pex.test.test_exception(t);
end

function test__xgcd_tail__format(t)
    pex.test.test_format(t);
end

function test__xgcd_tail__output(t)
    pex.test.test_output(t);
end

function test__xgcd_tail__warning(t)
