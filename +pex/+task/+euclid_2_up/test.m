...
function test__euclid_2_up__count(t)
    pex.test.test_count(t);
end

function test__euclid_2_up__dependence(t)
    pex.test.test_dependence(t);
end

function test__euclid_2_up__exception(t)
    pex.test.test_exception(t);
end

function test__euclid_2_up__format(t)
    pex.test.test_format(t);
end

function test__euclid_2_up__output(t)
    pex.test.test_output(t);
end

function test__euclid_2_up__warning(t)
