...
function test__play__count(t)
    pex.test.test_count(t);
end

function test__play__dependence(t)
    pex.test.test_dependence(t);
end

function test__play__exception(t)
    pex.test.test_exception(t);
end

function test__play__format(t)
    pex.test.test_format(t);
end

function test__play__output(t)
    pex.test.test_output(t);
end

function test__play__warning(t)
