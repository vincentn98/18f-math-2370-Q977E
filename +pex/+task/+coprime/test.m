...
function test__coprime__count(t)
    pex.test.test_count(t);
end

function test__coprime__dependence(t)
    pex.test.test_dependence(t);
end

function test__coprime__exception(t)
    pex.test.test_exception(t);
end

function test__coprime__format(t)
    pex.test.test_format(t);
end

function test__coprime__output(t)
    pex.test.test_output(t);
end

function test__coprime__warning(t)
