...
function test__xgcd_while__count(t)
    pex.test.test_count(t);
end

function test__xgcd_while__dependence(t)
    pex.test.test_dependence(t);
end

function test__xgcd_while__exception(t)
    pex.test.test_exception(t);
end

function test__xgcd_while__format(t)
    pex.test.test_format(t);
end

function test__xgcd_while__output(t)
    pex.test.test_output(t);
end

function test__xgcd_while__warning(t)
