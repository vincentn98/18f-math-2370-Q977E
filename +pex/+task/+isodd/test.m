...
function test__isodd__count(t)
    pex.test.test_count(t);
end

function test__isodd__dependence(t)
    pex.test.test_dependence(t);
end

function test__isodd__exception(t)
    pex.test.test_exception(t);
end

function test__isodd__format(t)
    pex.test.test_format(t);
end

function test__isodd__output(t)
    pex.test.test_output(t);
end

function test__isodd__warning(t)
