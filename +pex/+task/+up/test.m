...
function test__up__count(t)
    pex.test.test_count(t);
end

function test__up__dependence(t)
    pex.test.test_dependence(t);
end

function test__up__exception(t)
    pex.test.test_exception(t);
end

function test__up__format(t)
    pex.test.test_format(t);
end

function test__up__output(t)
    pex.test.test_output(t);
end

function test__up__warning(t)
