...
function test__xgcd_lcm_Z_LA__count(t)
    pex.test.test_count(t);
end

function test__xgcd_lcm_Z_LA__dependence(t)
    pex.test.test_dependence(t);
end

function test__xgcd_lcm_Z_LA__exception(t)
    pex.test.test_exception(t);
end

function test__xgcd_lcm_Z_LA__format(t)
    pex.test.test_format(t);
end

function test__xgcd_lcm_Z_LA__output(t)
    pex.test.test_output(t);
end

function test__xgcd_lcm_Z_LA__warning(t)
