...
function test__isR__count(t)
    pex.test.test_count(t);
end

function test__isR__dependence(t)
    pex.test.test_dependence(t);
end

function test__isR__exception(t)
    pex.test.test_exception(t);
end

function test__isR__format(t)
    pex.test.test_format(t);
end

function test__isR__output(t)
    pex.test.test_output(t);
end

function test__isR__warning(t)
