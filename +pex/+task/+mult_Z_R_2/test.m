...
function test__mult_Z_R_2__count(t)
    pex.test.test_count(t);
end

function test__mult_Z_R_2__dependence(t)
    pex.test.test_dependence(t);
end

function test__mult_Z_R_2__exception(t)
    pex.test.test_exception(t);
end

function test__mult_Z_R_2__format(t)
    pex.test.test_format(t);
end

function test__mult_Z_R_2__output(t)
    pex.test.test_output(t);
end

function test__mult_Z_R_2__warning(t)
