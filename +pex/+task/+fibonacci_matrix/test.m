...
function test__fibonacci_matrix__count(t)
    pex.test.test_count(t);
end

function test__fibonacci_matrix__dependence(t)
    pex.test.test_dependence(t);
end

function test__fibonacci_matrix__exception(t)
    pex.test.test_exception(t);
end

function test__fibonacci_matrix__format(t)
    pex.test.test_format(t);
end

function test__fibonacci_matrix__output(t)
    pex.test.test_output(t);
end

function test__fibonacci_matrix__warning(t)
