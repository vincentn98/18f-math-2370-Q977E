...
function test__gcd_s__count(t)
    pex.test.test_count(t);
end

function test__gcd_s__dependence(t)
    pex.test.test_dependence(t);
end

function test__gcd_s__exception(t)
    pex.test.test_exception(t);
end

function test__gcd_s__format(t)
    pex.test.test_format(t);
end

function test__gcd_s__output(t)
    pex.test.test_output(t);
end

function test__gcd_s__warning(t)
