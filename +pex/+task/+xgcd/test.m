...
function test__xgcd__count(t)
    pex.test.test_count(t);
end

function test__xgcd__dependence(t)
    pex.test.test_dependence(t);
end

function test__xgcd__exception(t)
    pex.test.test_exception(t);
end

function test__xgcd__format(t)
    pex.test.test_format(t);
end

function test__xgcd__output(t)
    pex.test.test_output(t);
end

function test__xgcd__warning(t)
