...
function test__down__count(t)
    pex.test.test_count(t);
end

function test__down__dependence(t)
    pex.test.test_dependence(t);
end

function test__down__exception(t)
    pex.test.test_exception(t);
end

function test__down__format(t)
    pex.test.test_format(t);
end

function test__down__output(t)
    pex.test.test_output(t);
end

function test__down__warning(t)
