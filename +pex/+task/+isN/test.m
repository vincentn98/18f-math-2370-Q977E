...
function test__isN__count(t)
    pex.test.test_count(t);
end

function test__isN__dependence(t)
    pex.test.test_dependence(t);
end

function test__isN__exception(t)
    pex.test.test_exception(t);
end

function test__isN__format(t)
    pex.test.test_format(t);
end

function test__isN__output(t)
    pex.test.test_output(t);
end

function test__isN__warning(t)
