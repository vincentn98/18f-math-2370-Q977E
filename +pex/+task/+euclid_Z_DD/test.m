...
function test__euclid_Z_DD__count(t)
    pex.test.test_count(t);
end

function test__euclid_Z_DD__dependence(t)
    pex.test.test_dependence(t);
end

function test__euclid_Z_DD__exception(t)
    pex.test.test_exception(t);
end

function test__euclid_Z_DD__format(t)
    pex.test.test_format(t);
end

function test__euclid_Z_DD__output(t)
    pex.test.test_output(t);
end

function test__euclid_Z_DD__warning(t)
