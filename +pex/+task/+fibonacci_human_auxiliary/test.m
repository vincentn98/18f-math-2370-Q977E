...
function test__fibonacci_human_auxiliary__count(t)
    pex.test.test_count(t);
end

function test__fibonacci_human_auxiliary__dependence(t)
    pex.test.test_dependence(t);
end

function test__fibonacci_human_auxiliary__exception(t)
    pex.test.test_exception(t);
end

function test__fibonacci_human_auxiliary__format(t)
    pex.test.test_format(t);
end

function test__fibonacci_human_auxiliary__output(t)
    pex.test.test_output(t);
end

function test__fibonacci_human_auxiliary__warning(t)
