...
function test__mult_N_R__count(t)
    pex.test.test_count(t);
end

function test__mult_N_R__dependence(t)
    pex.test.test_dependence(t);
end

function test__mult_N_R__exception(t)
    pex.test.test_exception(t);
end

function test__mult_N_R__format(t)
    pex.test.test_format(t);
end

function test__mult_N_R__output(t)
    pex.test.test_output(t);
end

function test__mult_N_R__warning(t)
