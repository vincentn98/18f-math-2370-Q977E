...
function test__euclid_G_hat__count(t)
    pex.test.test_count(t);
end

function test__euclid_G_hat__dependence(t)
    pex.test.test_dependence(t);
end

function test__euclid_G_hat__exception(t)
    pex.test.test_exception(t);
end

function test__euclid_G_hat__format(t)
    pex.test.test_format(t);
end

function test__euclid_G_hat__output(t)
    pex.test.test_output(t);
end

function test__euclid_G_hat__warning(t)
