...
function test__gcd_2__count(t)
    pex.test.test_count(t);
end

function test__gcd_2__dependence(t)
    pex.test.test_dependence(t);
end

function test__gcd_2__exception(t)
    pex.test.test_exception(t);
end

function test__gcd_2__format(t)
    pex.test.test_format(t);
end

function test__gcd_2__output(t)
    pex.test.test_output(t);
end

function test__gcd_2__warning(t)
