...
function test__euclid_F__count(t)
    pex.test.test_count(t);
end

function test__euclid_F__dependence(t)
    pex.test.test_dependence(t);
end

function test__euclid_F__exception(t)
    pex.test.test_exception(t);
end

function test__euclid_F__format(t)
    pex.test.test_format(t);
end

function test__euclid_F__output(t)
    pex.test.test_output(t);
end

function test__euclid_F__warning(t)
